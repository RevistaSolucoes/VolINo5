...
&\\
{\color{bluesol}\fontsize{50}{50}\selectfont Vol. I, No. 5}&\\
&\\
\rowcolor{csccccccc}
Nada é impossível:  Valentín Matamoros Arroyo  & {\fontsize{40}{40}\selectfont 1}\\
\rowcolor{cscccccc}
Solução em ação: Raúl Alegre Martínez &  {\fontsize{40}{40}\selectfont 3}\\
\rowcolor{csccccc}
Matemática em engenharia: Análise harmónica & \\
\rowcolor{csccccc}
 clássica, Parte I & {\fontsize{40}{40}\selectfont 5}\\
\rowcolor{cscccc}
Informática en ingeniería: Tipos de datos y funciones & {\fontsize{40}{40}\selectfont 14}\\
\rowcolor{csccc}
Novedades:  Un supermercado de bajo  &\\
\rowcolor{csccc}
consumo eléctrico &{\fontsize{40}{40}\selectfont 19}\\
\rowcolor{cscc}
Pensar jugando&  {\fontsize{40}{40}\selectfont 21}\\
\end{tabularx}}}
\end{document}
%%% Local Variables: 
%%% mode: latex
