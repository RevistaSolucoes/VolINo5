...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node [yshift=-0.75cm, xshift=0.3cm, anchor=west] at (current page.north west) 
      {\color{gray!10}\fontsize{0.4cm}{0.5em}
        {\bf REVISTA SOLUÇÕES} 
        };

  \node [yshift=3.25cm] at (current page.center) 
      {\color{redsol}\fontsize{1.2cm}{1em}
        \includegraphics[width=0.8\linewidth]{AnagramaOriginal_Saema.eps}
        };
\end{tikzpicture}
